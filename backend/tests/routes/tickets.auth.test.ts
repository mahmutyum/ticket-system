...
function makeApp(ticketCompanyId: string) {
  ...
  const attachmentCreate = vi.fn(async () => ({
    id: 'att1', ticketId: TICKET_ID, fileName: 'a.txt', filePath: 'ticket/a.txt',
    fileSize: 7, mimeType: 'text/plain', uploadedBy: 'admin@test.local', createdAt: new Date(),
  }));
