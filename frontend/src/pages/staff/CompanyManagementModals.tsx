...
export function CompanyFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="dialog-surface p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <h2 className="dialog-title mb-4">{editId ? t('companyMgmt.editCompany') : t('companyMgmt.newCompany')}</h2>
          ...
          <div className="border-t border-subtle pt-3 space-y-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input type="color" className="w-12 h-10 rounded-control border border-gray-300 dark:border-slate-700 bg-transparent cursor-pointer" value={form.primaryColor || '#2563eb'} onChange={(event) => setForm({ ...form, primaryColor: event.target.value })} />
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                {form.logo
                  ? <img src={form.logo} alt={t('companyMgmt.form.logoAlt')} className="w-14 h-14 object-contain rounded-control border border-subtle bg-white p-1" />
                  : <div className="w-14 h-14 rounded-control border border-dashed border-subtle flex items-center justify-center text-xs text-muted">{t('companyMgmt.form.logo')}</div>}
...
export function LocationFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="dialog-surface p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <h2 className="dialog-title mb-4">{editId ? t('companyMgmt.editLocation') : t('companyMgmt.newLocation')}</h2>
        <form onSubmit={onSubmit} className="space-y-3">
          <div>
...
export function SmtpConfigModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="dialog-surface p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <h2 className="dialog-title flex items-center gap-2 mb-4">
